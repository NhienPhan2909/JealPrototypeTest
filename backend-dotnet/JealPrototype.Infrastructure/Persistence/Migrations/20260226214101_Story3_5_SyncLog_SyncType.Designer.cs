...
namespace JealPrototype.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260226214101_Story3_5_SyncLog_SyncType")]
    partial class Story3_5_SyncLog_SyncType
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("JealPrototype.Domain.Entities.SystemSettings", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 2, 26, 21, 40, 57, 601, DateTimeKind.Utc).AddTicks(888),
                            Description = "Global toggle for all EasyCars stock synchronization",
                            UpdatedAt = new DateTime(2026, 2, 26, 21, 40, 57, 601, DateTimeKind.Utc).AddTicks(890),
                            Value = "true"
                        },
                        new
                        {
                            Key = "easycar_sync_cron",
                            CreatedAt = new DateTime(2026, 2, 26, 21, 40, 57, 601, DateTimeKind.Utc).AddTicks(891),
                            Description = "Cron expression for sync schedule (default: 2 AM daily)",
                            UpdatedAt = new DateTime(2026, 2, 26, 21, 40, 57, 601, DateTimeKind.Utc).AddTicks(892),
                            Value = "0 2 * * *"
                        },
                        new
                        {
                            Key = "easycar_sync_concurrency",
                            CreatedAt = new DateTime(2026, 2, 26, 21, 40, 57, 601, DateTimeKind.Utc).AddTicks(892),
                            Description = "Max concurrent dealership syncs (1=sequential)",
                            UpdatedAt = new DateTime(2026, 2, 26, 21, 40, 57, 601, DateTimeKind.Utc).AddTicks(893),
                            Value = "1"
                        },
                        new
                        {
                            Key = "easycar_image_sync_enabled",
                            CreatedAt = new DateTime(2026, 2, 26, 21, 40, 57, 601, DateTimeKind.Utc).AddTicks(893),
