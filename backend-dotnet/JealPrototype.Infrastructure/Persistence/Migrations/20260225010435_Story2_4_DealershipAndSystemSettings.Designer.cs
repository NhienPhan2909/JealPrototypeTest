...
namespace JealPrototype.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260225010435_Story2_4_DealershipAndSystemSettings")]
    partial class Story2_4_DealershipAndSystemSettings
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("JealPrototype.Domain.Entities.SystemSettings", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 2, 25, 1, 4, 32, 322, DateTimeKind.Utc).AddTicks(4801),
                            Description = "Global toggle for all EasyCars stock synchronization",
                            UpdatedAt = new DateTime(2026, 2, 25, 1, 4, 32, 322, DateTimeKind.Utc).AddTicks(4804),
                            Value = "true"
                        },
                        new
                        {
                            Key = "easycar_sync_cron",
                            CreatedAt = new DateTime(2026, 2, 25, 1, 4, 32, 322, DateTimeKind.Utc).AddTicks(4807),
                            Description = "Cron expression for sync schedule (default: 2 AM daily)",
                            UpdatedAt = new DateTime(2026, 2, 25, 1, 4, 32, 322, DateTimeKind.Utc).AddTicks(4807),
                            Value = "0 2 * * *"
                        },
                        new
                        {
                            Key = "easycar_sync_concurrency",
                            CreatedAt = new DateTime(2026, 2, 25, 1, 4, 32, 322, DateTimeKind.Utc).AddTicks(4808),
                            Description = "Max concurrent dealership syncs (1=sequential)",
                            UpdatedAt = new DateTime(2026, 2, 25, 1, 4, 32, 322, DateTimeKind.Utc).AddTicks(4809),
                            Value = "1"
                        });
                });
