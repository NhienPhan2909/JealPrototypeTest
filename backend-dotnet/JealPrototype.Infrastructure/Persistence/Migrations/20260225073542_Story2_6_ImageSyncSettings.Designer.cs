...
namespace JealPrototype.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260225073542_Story2_6_ImageSyncSettings")]
    partial class Story2_6_ImageSyncSettings
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("JealPrototype.Domain.Entities.SystemSettings", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 2, 25, 7, 35, 39, 965, DateTimeKind.Utc).AddTicks(1788),
                            Description = "Global toggle for all EasyCars stock synchronization",
                            UpdatedAt = new DateTime(2026, 2, 25, 7, 35, 39, 965, DateTimeKind.Utc).AddTicks(1791),
                            Value = "true"
                        },
                        new
                        {
                            Key = "easycar_sync_cron",
                            CreatedAt = new DateTime(2026, 2, 25, 7, 35, 39, 965, DateTimeKind.Utc).AddTicks(1792),
                            Description = "Cron expression for sync schedule (default: 2 AM daily)",
                            UpdatedAt = new DateTime(2026, 2, 25, 7, 35, 39, 965, DateTimeKind.Utc).AddTicks(1793),
                            Value = "0 2 * * *"
                        },
                        new
                        {
                            Key = "easycar_sync_concurrency",
                            CreatedAt = new DateTime(2026, 2, 25, 7, 35, 39, 965, DateTimeKind.Utc).AddTicks(1793),
                            Description = "Max concurrent dealership syncs (1=sequential)",
                            UpdatedAt = new DateTime(2026, 2, 25, 7, 35, 39, 965, DateTimeKind.Utc).AddTicks(1794),
                            Value = "1"
                        },
                        new
                        {
                            Key = "easycar_image_sync_enabled",
                            CreatedAt = new DateTime(2026, 2, 25, 7, 35, 39, 965, DateTimeKind.Utc).AddTicks(1794),
                            Description = "Enable/disable image sync during stock sync (default: true)",
                            UpdatedAt = new DateTime(2026, 2, 25, 7, 35, 39, 965, DateTimeKind.Utc).AddTicks(1795),
                            Value = "true"
                        });
                });
