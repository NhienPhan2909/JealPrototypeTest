...
namespace JealPrototype.Infrastructure.Migrations
{
    ...
    [Migration("20260224112935_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JealPrototype.Domain.Entities.EasyCarsSyncLog", b =>
                {
                    ...
                    b.HasIndex("DealershipId")
                        .HasDatabaseName("idx_sync_logs_dealership");

                    b.HasIndex("StartedAt")
                        .IsDescending()
                        .HasDatabaseName("idx_sync_logs_started_at");

                    b.HasIndex("Status")
                        .HasDatabaseName("idx_sync_logs_status");

                    b.HasIndex("SyncType")
                        .HasDatabaseName("idx_sync_logs_sync_type");

                    b.ToTable("easycars_sync_logs", null, t =>
                        {
                            t.HasCheckConstraint("CK_sync_logs_completed_at", "completed_at IS NULL OR completed_at >= started_at");

                            t.HasCheckConstraint("CK_sync_logs_status", "status IN ('Success', 'Failed', 'Warning', 'InProgress')");

                            t.HasCheckConstraint("CK_sync_logs_sync_direction", "sync_direction IN ('Inbound', 'Outbound')");

                            t.HasCheckConstraint("CK_sync_logs_sync_type", "sync_type IN ('Stock', 'Lead')");
                        });
                });
            ...
            modelBuilder.Entity("JealPrototype.Domain.Entities.EasyCarsSyncLog", b =>
                {
                    b.HasOne("JealPrototype.Domain.Entities.EasyCarsCredential", "Credential")
                        .WithMany()
