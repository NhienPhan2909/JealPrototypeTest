/**
 * DeleteConfirmDialog - Confirmation dialog for deleting EasyCars credentials
 */

const DeleteConfirmDialog = ({ isDeleting, onConfirm, onCancel }) => {
  return (
          ...
          <div className="sm:flex sm:items-start">
            ...
            <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
              <h3 className="text-lg leading-6 font-medium text-gray-900" id="modal-title">
                Delete EasyCars Credentials?
              </h3>
              <div className="mt-2">
                <p className="text-sm text-gray-500">
                  Are you sure you want to delete these credentials? This will stop all EasyCars synchronization
                  and remove all stored credentials. <strong>This action cannot be undone.</strong>
                </p>
              </div>
            </div>
          </div>
