/**
 * @fileoverview StockSyncDashboard - Dashboard component showing last sync status
 * Displays sync summary, sync now button, and credential warnings
 */
...
/**
 * StockSyncDashboard - Displays last sync summary and sync now button
 */
export default function StockSyncDashboard({ 
  ...
  return (
    <div className="bg-white rounded-lg shadow p-6 mb-6">
      <h2 className="text-xl font-bold mb-4">Last Sync Status</h2>
          ...
          <div className="flex">
            ...
            <div className="ml-3">
              ...
              <div className="mt-2 text-sm text-yellow-700">
                <p>Stock synchronization requires valid EasyCars credentials.</p>
                <a 
                  href="/admin/settings" 
        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
            <div className="bg-gray-50 p-3 rounded">
              <p className="text-sm text-gray-600">Vehicles Processed</p>
      ...
      <div className="mt-6">
        <button
          ...
          title={!hasCredentials ? 'Configure credentials to enable sync' : 'Trigger immediate stock synchronization'}
        >
          {isSyncing ? (
            <>
